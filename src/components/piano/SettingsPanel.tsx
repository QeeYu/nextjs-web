    ...
    >
      ...
      >
        <div className="mb-5 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="cursor-pointer rounded-full bg-white/10 px-3 py-1 text-sm text-dim hover:bg-white/20"
          >
            ✕
          </button>
        </div>
            ...
            {KEY_COUNT_OPTIONS.map((o) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className={`text-sm font-bold ${keyCount === o.count ? "text-cyan" : "text-mist"}`}>
                    {o.label}
                  </span>
        ...
        <section className="mb-6">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setListeningKey("up")}
                className={`cursor-pointer rounded-lg border px-4 py-1.5 font-mono text-xs ${
                  listeningKey === "up"
                    ? "animate-pulse border-cyan bg-cyan/15 text-cyan"
                    : "border-white/15 bg-white/5 text-mist hover:bg-white/10"
                }`}
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setListeningKey("sustain")}
                className={`cursor-pointer rounded-lg border px-4 py-1.5 font-mono text-xs ${
                  listeningKey === "sustain"
                    ? "animate-pulse border-pink bg-pink/15 text-pink"
                    : "border-white/15 bg-white/5 text-mist hover:bg-white/10"
                }`}
              >
        ...
        <section>
          ...
          <textarea
            ...
            rows={4}
            placeholder="C4 C4 G4 G4 A4 A4 G4 - ..."
          ...
          />
          <button
            onClick={() => onLoadScore(importText)}
